...
{
	if(LiftingMotorBias[0] + TOTALLY_DOWN_SETPOINT - CM1Encoder.ecd_angle > -1000)
		TP_LeftFrontReachLower = 1;
	else TP_LeftFrontReachLower = 0;
	if(LiftingMotorBias[1] + TOTALLY_DOWN_SETPOINT - CM2Encoder.ecd_angle > -1000)
		TP_RightFrontReachLower = 1;
	else TP_RightFrontReachLower = 0;
	if(LiftingMotorBias[2] + TOTALLY_DOWN_SETPOINT - CM3Encoder.ecd_angle > -1000)
		TP_RightBackReachLower = 1;
	else TP_RightBackReachLower = 0;
	if(LiftingMotorBias[3] + TOTALLY_DOWN_SETPOINT - CM4Encoder.ecd_angle > -1000)
